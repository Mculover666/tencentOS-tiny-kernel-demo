...
void entry_task_sender(void *arg)
{
    ...
    printf("sender: post message 2 without priority\n");
    tos_msg_q_post(&msg_q, msg_prio_2);

    printf("sender: post message 1 without priority\n");
    tos_msg_q_post(&msg_q, msg_prio_1);

    printf("sender: post message 0 with priority\n");
...
sender: post message 2 without priority
sender: post message 1 without priority
sender: post message 0 with priority
